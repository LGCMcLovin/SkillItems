package io.github.LGCMcLovin.skillItems.commands;
        ...
        if (sender instanceof Player){
            ...
            if (player.isOp()){
                if (args.length>0){
                                    ...
                                    if (Bukkit.getPlayer(args[2])!=null){
                                        if (Bukkit.getPlayer(args[2]).isOnline()){
                                            if (Bukkit.getPlayer(args[2]).getInventory().firstEmpty()!=-1){
                                                Bukkit.getPlayer(args[2]).getInventory().setItem(Bukkit.getPlayer(args[2]).getInventory().firstEmpty(), instance.getItemHandler().createItem(args[1]));
                                                player.sendMessage(Util.edit("Item has been added to player�s inventory."));
                                            }else{player.sendMessage(Util.edit("Player has full inventory."));}
                                        }else{player.sendMessage(Util.edit("Player is offline."));}
                                    }else{player.sendMessage(Util.edit("Player is offline."));}
                                }else{player.sendMessage(Util.edit("Item does not exist!"));}

                            }else{player.sendMessage(Util.edit("Usage: /ci create <item name> <player>"));}
                        }else{player.sendMessage(Util.edit(ChatColor.RED+"You dont have permission!"));}
                        ...
                        if (instance.hasPermission(player, "custom-items.info")){
                            if (player.getItemInHand()!=null){
                                if (instance.getItemHandler().isCustom(player.getItemInHand())){
                                    ...
                                    ArrayList<String> list = instance.getItemHandler().getItemAbilities(player.getItemInHand());
                                    for(String ab : list){
                                        player.sendMessage(ab);
                                    }
                                }else{player.sendMessage(Util.edit("You dont have a custom item in your hands!"));}
                            }else{player.sendMessage(Util.edit("You dont have a custom item in your hands!"));}
                        }else{player.sendMessage(Util.edit(ChatColor.RED+"You dont have permission!"));}
                    ...
                    }else{player.sendMessage(Util.edit("Usage: /ci help"));}
                }else{player.sendMessage(Util.edit("Usage: /ci help"));}
            }else{player.sendMessage(Util.edit(ChatColor.RED+"You dont have permission!"));}
            ...
            if (args.length>0){
                        ...
                        if (instance.getItemHandler().getItemType().containsKey(args[1])){
                            if (Bukkit.getPlayer(args[2])!=null){
                                if (Bukkit.getPlayer(args[2]).isOnline()){
                                    if (Bukkit.getPlayer(args[2]).getInventory().firstEmpty()!=-1){
                                        Bukkit.getPlayer(args[2]).getInventory().setItem(Bukkit.getPlayer(args[2]).getInventory().firstEmpty(), instance.getItemHandler().createItem(args[1]));
                                        instance.getLog().info(Util.editConsole("Item has been added to player�s inventory."));
                                    }else{instance.getLog().info(Util.editConsole("Player has full inventory."));}
                                }else{instance.getLog().info(Util.editConsole("Player is offline."));}
                            }else{instance.getLog().info(Util.editConsole("Player is offline."));}
                        }else{instance.getLog().info(Util.editConsole("Item does not exist!"));}

                    }else{instance.getLog().info(Util.editConsole("Usage: /ci create <item name> <player>"));}
                ...
                }else{instance.getLog().info(Util.editConsole("Usage: /ci help"));}
